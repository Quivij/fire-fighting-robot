...
AUTO_MODE_ENABLED = True  # Default: auto mode ALWAYS ON
...
AUTO_SPEED_FORWARD = 90  # Motor speed forward (robot nặng - tốc độ vừa phải)
AUTO_SPEED_TURN = 100  # Turn speed (robot nặng - cần tốc độ CAO để quay)
AUTO_MIN_DISTANCE_CM = 25  # Stop if obstacle closer (INCREASED for safety)
AUTO_CONTROL_LOOP_HZ = 1  # Control loop frequency (2 Hz = 500ms update)
